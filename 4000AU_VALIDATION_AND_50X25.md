...
4000 a.u. 的 D3/F384、D3/F512 参考任务 647702、647703 已完成；三次独立百万路径 647704、647705、647706 均完成。相同种子的 F512 对照 647707 也已完成并于 2026-09-08 收齐：完整输出相对 F384 最大差 9.696e-11，未见有意义的精度收益。
...
这两次采样与 D2 参考最大占据差异分别为 3.287e-3、7.403e-4，仍出现负占据数，不能视为高精度。D1/F384 与 D2/F384 确定性参考最大差异仅 5.662e-15；这支持将优化重点放在随机残差估计，但相邻截断一致不能排除共享偏差。D2/F512 对照 647779 已完成并于 2026-09-08 收齐：完整作业 19.406 小时，峰值和 27.266 GiB；F384/F512 参考最大占据差 2.243e-11，仍不能用相邻截断一致代替全空间真值验证。
...
原模式的两个对照 647807_0、647807_1 已完成，墙钟约 36.97、36.91 分钟，实际 CPU 总计 78.73、78.60 小时；最大进程峰值 21.16、22.82 MiB，峰值和 2.394、2.405 GiB。最弱相对参考诊断为 0.162、0.0257，表明种子间尾部波动明显。新模式现已收齐，结果见文末 2026-09-08 更新；尚不能宣称达到高精度。详细设置、旧任务取消记录和完整资源验证见 scan_rate_4000_20260907/README.md、sampling_validation.json。候选还需独立大样本验证。
...
三种体系的标参全轨道图、选择规则与分阶段成本见 [2026-09-08 图表包](best_orbital_figures_20260908/README.md)。
