...
首个百万路径结果与 D3/F384 参考的最大轨道差异为 2.764e-7；最小原始占据为 -2.345e-7，最大为 1.0000002764。输出未剪裁。这些波动与目标物理占据变化相比不可忽略。最差 100 a.u. 窗口的“参考信号 RMS / 样本相对参考差异 RMS”综合值为 2.718，最弱活跃轨道为 0.510。它们只是残差诊断，不是真实 QM 拟合；尤其早期几乎零残差形成的巨大比值不能视作真实高精度。
