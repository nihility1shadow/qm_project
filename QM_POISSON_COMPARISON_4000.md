...
D2 的一万路径结果仍出现 −2.195e-4 的占据数，最弱活跃轨道窗口的“参考信号 / 相对参考差异”仅 1.760e-4。该指标不是与全空间 QM 的拟合 Q。D1 与 D2 的确定性参考最大差异仅 5.662e-15，增加这一层参考并没有改变确定性信号，但随机估计波动仍很大。相邻截断一致不是严格全空间误差界；F384/F512 对照 647779 已于 2026-09-08 收齐，参考最大占据差 2.243e-11，扩大振动基未解决随机残差噪声。
